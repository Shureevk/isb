...
def main():
    ...
    if args.generation:
        HybridCryptoOperations.generate_keys(config)
    elif args.encryption:
        HybridCryptoOperations.encrypt_data(config)
    elif args.decryption:
        HybridCryptoOperations.decrypt_data(config)
